= message_passing
This is a method for creating real message passing (via TCP/IP) class.

== Usage
You can use "rclass" method like as "class" keyword. But you should use symbols instead of the constant of the class name and a block statement.
...
If you run this sample code, you can see the real TCP/IP message passing like the below.
  komamitsu@potato:~/lab/ruby$ sudo tcpdump -i lo
